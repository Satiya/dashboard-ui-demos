...
//		}
	 ...
	 $http({
			method : "GET",
			url: "http://52.8.104.253:8161/opsmx-cas-services/resources/api/getpolicy",
			headers: {'content-type': 'application/json'}
		}).success(function(response){
			$scope.policyTableDetails = response;
		...
		// code for detleting row in table
		
		 $scope.deletePolicyData = function(id,index){
  		 	$scope.policyTableDetails.splice(index,1);
  		 	$http({
  		  		method : "GET",
  		  		url: "http://52.8.104.253:8161/opsmx-cas-services/resources/api/deletepolicy?policyID="+id,
  		  		headers: {'content-type': 'application/json'}
  		  	}).success(function(response){
  		  	}).error(function(response){
...
$scope.editPolicyData = function(data){
